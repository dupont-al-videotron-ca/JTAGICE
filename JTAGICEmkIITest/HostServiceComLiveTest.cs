...
namespace JTAGICEmkIITest
{
    ...
    public class HostServiceComLiveTest : HostServiceBaseTest
    {
        public HostServiceComLiveTest() : base()
        {
        ...
        public void HostServiceLive_shall_Initialise()
        {
            ...
            //--- Setup
            var hostService = CreateHostService(-1, false);
        ...
        {
            var txRxadapt = new TxRxComAdaptor(new SerialConfig());
            _rxFrame = new RxFrame(txRxadapt);
            _txFrame = new TxFrame(txRxadapt);
