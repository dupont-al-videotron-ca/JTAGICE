...
namespace JTAGICEmkIITest
{
    public class ActivityClearEventsTest : ActivityBaseTest
    {
        ...
        public void ActivityClearEvents_Constructor_Test()
        {
            ...
            //--- Action
            var test = new ActivityClearEvents(
                _activityStructure, 
                null);
        ...
        {
            //--- Setup
            var test = new ActivityClearEvents(_activityStructure, null);
        ...
        {
            //--- Setup
            var parent = new ActivitySetDeviceDescriptor(_activityStructure, null);
            var test = new ActivityClearEvents(_activityStructure, parent);
        ...
        [Fact]
        public void ActivityClearEvents_ActivityEntry_shall_return_true()
        {
            //--- Setup
            var test = new ActivityClearEvents(_activityStructure, null);
        ...
        [Fact]
        public void ActivityClearEvents_ActivityEntry_shall_return_false()
        {
            //--- Setup
            var test = new ActivityClearEvents(_activityStructure, null);
