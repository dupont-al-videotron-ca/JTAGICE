...
//TODO: move following define into application specific header file
#define Log4UsbEndpointNumber 1

#define State_WaitInit 0
#define State_WaitUsb 1
#define State_AppSarted 2
