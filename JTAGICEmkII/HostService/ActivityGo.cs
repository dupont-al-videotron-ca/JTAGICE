...
{
    public sealed class ActivityGo : ActivityProcessCommandBase
    {


        #region Constructors 
        public ActivityGo(StructureActivity activityStructure) : 
            base(activityStructure, MasterCommandEnum.CMND_GO, SlaveResponseEnum.RSP_OK)
        {
        }
        #endregion
